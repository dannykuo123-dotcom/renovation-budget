...
describe("calculateTotals", () => {
  it("separates incoming funds, paid expense, pending expense, and refunds", () => {
    ...
    expect(totals).toEqual({ planned: 100000, received: 150000, spent: 37000, pending: 10000, returned: 3000, cashBalance: 113000, budgetRemaining: 63000 });
  });
  ...
  it("returns a fully refunded expense to the available balance and budget", () => {
    ...
    expect(totals).toEqual({ planned: 100000, received: 100000, spent: 0, pending: 0, returned: 25000, cashBalance: 100000, budgetRemaining: 100000 });
  });
});
